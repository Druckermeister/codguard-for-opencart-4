...
namespace Opencart\Admin\Model\Extension\Codguard\Module;
...
class Codguard extends \Opencart\System\Engine\Model {
    ...
    public function install(): void {
        ...
        $this->model_setting_event->addEvent([
            ...
            'description' => 'CodGuard checkout validation script injection',
            'trigger' => 'catalog/view/common/footer/before',
            'action' => 'extension/codguard/module/codguard.injectCheckoutScript',
            'status' => 1,
            'sort_order' => 999
        ]);
